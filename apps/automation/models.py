...
class NotificacionInteligente(AgenciaMixin, models.Model):
    ...
    usuario = models.ForeignKey(User, on_delete=models.CASCADE, related_name='notificaciones_inteligentes_auto', null=True, blank=True)
...
class NotificacionAgente(AgenciaMixin, models.Model):
    ...
    usuario = models.ForeignKey(User, on_delete=models.CASCADE, related_name='notificaciones_agente_auto', null=True, blank=True)
    titulo = models.CharField(max_length=150)
    mensaje = models.TextField()

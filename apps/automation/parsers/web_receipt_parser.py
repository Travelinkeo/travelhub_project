...
from apps.automation.parsers.parsing_utils import _parse_currency_amount, _clean_value
...
class WebReceiptParser:
    ...
    def _clean_money(self, val_str: str) -> Decimal:
        ...
        try:
            ...
            logger.warning(f"⚠️ Error convirtiendo monto '{val_str}' a Decimal: {e}")
            return Decimal(0)

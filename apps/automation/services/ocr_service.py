...
from apps.automation.services.prompts import PASSPORT_OCR_SYSTEM_PROMPT
from core.api import PasaporteOCRSchema
            ...
            try:
                ...
                if nac_iso:
                    pais_nac = Pais.objects.filter(
                        models.Q(codigo_iso_3=nac_iso.upper()) | models.Q(nombre__icontains=nac_iso)
                    ).first()
                    if pais_nac:

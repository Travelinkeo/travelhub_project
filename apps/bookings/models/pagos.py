...
class FeeVenta(SoftDeleteModel, AgenciaMixin, models.Model):
    ...
    venta = models.ForeignKey('bookings.Venta', related_name='fees_venta', on_delete=models.CASCADE, verbose_name=_("Venta"), null=True, blank=True)
...
class PagoVenta(AgenciaMixin, models.Model):
    ...
    venta = models.ForeignKey('bookings.Venta', related_name='pagos_venta', on_delete=models.CASCADE, verbose_name=_("Venta"), null=True, blank=True)

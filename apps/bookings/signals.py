...
def capturar_estado_anterior_venta(sender, instance, **kwargs):
    """capturar_estado_anterior_venta."""
    if are_signals_blocked():
        logger.info(

    ...
    class Meta:
        ...
        widgets = {
            "titulo": forms.TextInput(
                attrs={
                    "class": "w-full bg-slate-900 border border-slate-700 rounded-xl px-4 py-2 text-white"
                }
            ),
            ...
            "meta_titulo": forms.TextInput(
                attrs={
                    "class": "w-full bg-slate-900 border border-slate-700 rounded-xl px-4 py-2 text-white"
                }
            ),
            "meta_descripcion": forms.Textarea(
                attrs={
                    "class": "w-full bg-slate-900 border border-slate-700 rounded-xl px-4 py-2 text-white",
                    "rows": 2,
                }
...
class GuiaDestinoForm:
    ...
    class Meta:
        ...
        widgets = {
            ...
            "mejor_epoca": forms.TextInput(
                attrs={
                    "class": "w-full bg-slate-900 border border-slate-700 rounded-xl px-4 py-2 text-white"
                }
            ),
            "requisitos_visa": forms.Textarea(
                attrs={
                    "class": "w-full bg-slate-900 border border-slate-700 rounded-xl px-4 py-2 text-white",
                    "rows": 3,
                }

...
class Migration(migrations.Migration):
    dependencies = [
        (
            "communications",
            "0010_alter_notificationpreference_unique_together_and_more",
        ),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "channel",
                    models.CharField(help_text="Canal utilizado", max_length=20),
                ),
                (
                    "recipient",
                    models.CharField(
                ...
                (
                    "retry_count",
                    models.IntegerField(default=0, help_text="Cantidad de reintentos"),
                ),
                (
                    "sent_at",
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Tipo de objeto (ej: 'venta')",
                        max_length=100,
                    ),
                ),
                (
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="communicati_status_67a417_idx",
                    ),
                    models.Index(
                        fields=["event_type", "created_at"],
                        name="communicati_event_t_28f39a_idx",
                    ),
                    models.Index(
                        fields=["channel", "created_at"],
                        name="communicati_channel_d4a183_idx",
                    ),
                ],
            },
        ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="communicati_user_id_501e1d_idx",
                    ),
                    models.Index(
                        fields=["agencia", "event_type"],
                        name="communicati_agencia_758c36_idx",
                    ),
                ],

...
class EmailMonitorService:
    ...
    def _procesar_correos(self):
        ...
        if not self.agencia.correo_emisiones or not self.agencia.password_app_correo:
        ...
        try:
            # SaaS Multi-tenant: Usar credenciales de la agencia elegida
    ...
    def _enviar_telegram(self, sistema, localizador, numero_boleto, pasajero, aerolinea, pdf_path):
        ...
        from apps.common.utils.telegram_utils import send_telegram_file_sync

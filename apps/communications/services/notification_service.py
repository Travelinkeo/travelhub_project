...
def notificar_confirmacion_pago(pago_venta):
    ...
    """
    from .email_notifications import enviar_confirmacion_pago
    from .whatsapp_notifications import enviar_whatsapp_confirmacion_pago
...
"""
    # Enviar a un grupo de control o admin

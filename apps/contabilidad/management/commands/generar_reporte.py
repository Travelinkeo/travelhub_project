        ...
        try:
            if tipo == "balance_general":
                ...
                if tipo == "balance_comprobacion":
                    ...
                    self.stdout.write(
                        f"{'Código':<12} {'Cuenta':<40} {'Debe':>15} {'Haber':>15} {'Saldo':>15}"
                    )
                    ...
                    if utilidad >= 0:
                        ...
                        self.stdout.write(
                            self.style.ERROR(f"Pérdida Neta:  {abs(utilidad):>15,.2f}")
                        )
                    ...
                    for asiento in asientos:
                        ...
                        self.stdout.write(
                            f"{'Total:':<50} {asiento['total_debe']:>12,.2f} = {asiento['total_haber']:>12,.2f}"
                        )

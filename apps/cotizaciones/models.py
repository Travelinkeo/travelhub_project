...
class Cotizacion(models.Model):
    ...
    cliente = models.ForeignKey('crm.Cliente', on_delete=models.PROTECT, verbose_name=_("Cliente"), null=True, blank=True)
    ...
    image_url = models.URLField(_("Imagen de Destino (Unsplash)"), max_length=500, blank=True, null=True)
    metadata_ia = models.JSONField(_("Metadatos IA (Gemini)"), blank=True, null=True)
    agency_fee = models.DecimalField(_("Fee de Agencia (Markup)"), max_digits=12, decimal_places=2, default=0)
    ...
    def get_whatsapp_link(self):
        ...
        return f"https://wa.me/{telefono}?text={encoded_msg}" if telefono else f"https://wa.me/?text={encoded_msg}"

...
class FacturaConsolidada(models.Model):
    ...
    cliente = models.ForeignKey(Cliente, on_delete=models.PROTECT, verbose_name=_("Cliente"), null=True, blank=True)
...
class ItemFacturaConsolidada(models.Model):
    ...
    factura = models.ForeignKey(FacturaConsolidada, related_name='items_factura',
                               on_delete=models.CASCADE, verbose_name=_("Factura"), null=True, blank=True)
...
class DocumentoExportacionConsolidado(models.Model):
    ...
    factura = models.ForeignKey(FacturaConsolidada, related_name='documentos_exportacion', on_delete=models.CASCADE, null=True, blank=True)

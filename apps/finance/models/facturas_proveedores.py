...
class FacturaProveedor(SoftDeleteModel, AgenciaMixin, models.Model):
    """
    ...
    estado = models.CharField(
        ...
        default=EstadoFactura.PENDIENTE_CONCILIACION
    )
    ...
    datos_json = models.JSONField(
        default=dict, 
        blank=True, 
        help_text=_("Estructura completa extraída por IA")
    )

...
"""
Modelo para gestión de Retenciones de ISLR (Migrado desde core)
...
class RetencionISLR(AgenciaMixin, models.Model):
    ...
    fecha_operacion = models.DateField(
        _("Fecha de Operación"), null=True, blank=True, help_text=_("Fecha de la factura retenida")
    )
    periodo_fiscal = models.CharField(
        _("Período Fiscal"), max_length=7, null=True, blank=True, help_text=_("Formato: YYYY-MM")
    )
    ...
    estado = models.CharField(
        _("Estado"), max_length=3, choices=Estado.choices, default=Estado.PENDIENTE
    )

    # Archivo
    archivo_comprobante = models.FileField(
        _("Archivo Comprobante"),

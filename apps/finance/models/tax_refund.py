...
from core.api import AgenciaManager
...
class TaxRefundOpportunity(models.Model):
    ...
    boleto = models.OneToOneField(
        "bookings.BoletoImportado", on_delete=models.CASCADE, related_name="tax_refund_oo"
    )
    agencia = models.ForeignKey(
        "core.Agencia", on_delete=models.CASCADE, related_name="tax_refund_oo"
    )
    ...
    tracking_code_proveedor = models.CharField(
        max_length=100, blank=True, null=True, help_text="Ej. Global Blue Tracking ID"
    )

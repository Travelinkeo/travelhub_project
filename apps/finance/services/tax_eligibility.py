    ...
    def evaluar_boleto(boleto_id):
        try:
            ...
            if es_internacional and impuestos >= 50:
                ...
                logger.info(
                    f"💡 [TAX REFUND] Dinero sobre la mesa: ${monto_estimado} para PNR {boleto.localizador_pnr}"
                )
                return reclamo
...
def es_itinerario_internacional(boleto) -> bool:
    ...
    ciudades_nacionales = {
        ...
        "PORLAMAR", "BARCELONA", "PUERTO ORDAZ", "MATURIN",
        "SAN CRISTOBAL", "EL VIGIA", "LAS PIEDRAS", "MERIDA",
        "CCS", "MAR", "VLN", "BRM", "PMV", "BLA", "PZO", "STD",
        "VIG", "LSP", "CUM", "MUN", "SOM", "VCR", "CXA"
    }

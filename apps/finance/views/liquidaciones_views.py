...
class LiquidacionListView(LoginRequiredMixin, ListView):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        self.model = apps.get_model("contabilidad", "LiquidacionProveedor")
    ...
    def get_queryset(self):
        ...
        queryset = (
            LiquidacionProveedor.objects.all()
            .select_related("proveedor", "venta", "venta__cliente", "venta__moneda")
            .prefetch_related("items_liquidacion")
    ...
    def get_context_data(self, **kwargs):
        ...
        totales = self.get_queryset().aggregate(
            total_pendiente=Sum("saldo_pendiente"), total_pagado=Sum("monto_pagado")
        )
...
class LiquidacionCreateView(SaaSMixin, LoginRequiredMixin, TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if action == "load_items":
            ...
            if not proveedor_id:
                return render(
                    request, "finance/liquidaciones/partials/items_list.html", {"items": []}
                )
            ...
            items = (
                ...
                .select_related("venta", "producto_servicio", "venta__cliente", "venta__agencia")
                .order_by("venta__fecha_venta")
            )

            return render(
                request, "finance/liquidaciones/partials/items_list.html", {"items": items}
            )
            ...
            try:
                ...
                messages.success(
                    request, f"Liquidación #{liquidacion.id_liquidacion} creada exitosamente."
                )
...
class LiquidacionDetailView(SaaSMixin, LoginRequiredMixin, DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["items"] = self.object.items_liquidacion.select_related(
            "item_venta", "item_venta__venta"
        ).all()
        return context

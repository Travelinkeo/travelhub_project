...
class TaxRefundDashboardView(LoginRequiredMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        reclamos = (
            TaxRefundOpportunity.objects.filter(agencia=agencia)
            .select_related("boleto", "boleto__venta_asociada", "boleto__venta_asociada__cliente")
            .order_by("-creado_en")
        )
...
class IniciarTramiteRefundView(LoginRequiredMixin, View):
    ...
    def post(self, request, reclamo_id, *args, **kwargs):
        ...
        return render(
            request, "finance/tax_refund/partials/fila_reclamo.html", {"reclamo": reclamo}
        )

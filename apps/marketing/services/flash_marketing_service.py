...
class FlashMarketingService:
    ...
    def generate_flyer(
        self, destination: str, price: str, airline: str = None, agency_logo_path: str = None
    ) -> BytesIO:
        """
        ...
        try:
            ...
            try:
                ...
                ImageFont.truetype("arialbd.ttf", 50)
            except OSError:
                try:
            ...
            draw.text(
                (self.width // 2, 200), "OFERTA FLASH", font=font_small, fill="#fca5a5", anchor="mm"
            )
            ...
            if airline:
                ...
                if airline_logo_img:
                    ...
                    airline_logo_img = airline_logo_img.resize(

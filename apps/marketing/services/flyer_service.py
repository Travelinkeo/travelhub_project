...
class FlyerService:
    ...
    def generate_flyer(
        ...
        try:
            ...
            draw.text(
                (self.width // 2, card_y + 80), tag_text, font=font_tag, fill="#fbbf24", anchor="mm"
            )

            # Title (Destination or Hotel Name)
            draw.text(
                (self.width // 2, card_y + 220),
                title_text.upper(),
                font=font_title,
                fill="white",
                anchor="mm",

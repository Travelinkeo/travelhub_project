                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("promedio_venta", "Ticket Promedio"),
                            ("margen_bruto", "Margen Bruto %"),
                            ("utilidad_total", "Utilidad Total"),
                            ("boletos_importados", "Boletos Importados"),
                            ("tasa_exito_importacion", "Tasa de Éxito Importación"),
                            ("clientes_nuevos", "Clientes Nuevos"),
                            ("clientes_totales", "Clientes Totales"),
                            ("comisiones_pendientes", "Comisiones Pendientes"),
                            ("comisiones_liquidadas", "Comisiones Liquidadas"),
                        ],
                        max_length=40,
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        ...
                        help_text="Para frecuencia semanal",
                        null=True,
                    ),
                ),
                ("activo", models.BooleanField(default=True)),

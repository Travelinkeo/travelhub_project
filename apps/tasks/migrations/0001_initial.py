"""Migración de base de datos para tasks.
"""
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("estado", models.CharField(choices=[("pendiente", "Pendiente"), ("en_progreso", "En Progreso"), ("revision", "En Revisión"), ("completada", "Completada"), ("cancelada", "Cancelada")], default="pendiente", max_length=20)),
            ...
            options={"verbose_name": "Tarea", "verbose_name_plural": "Tareas", "ordering": ["-prioridad", "created_at"]},
        ),
        migrations.CreateModel(
            ...
            options={"verbose_name": "Comentario", "verbose_name_plural": "Comentarios", "ordering": ["created_at"]},
        ),
    ]

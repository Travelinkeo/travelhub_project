...
class CedulaOCRSchema(BaseModel):
    apellidos: Optional[str] = Field(default=None, description="Solo los apellidos del titular, en mayúsculas.")
    nombres: Optional[str] = Field(default=None, description="Solo los nombres del titular, en mayúsculas.")
    cedula: Optional[int] = Field(default=None, description="Solo números de la cédula.")
    fecha_nacimiento: Optional[str] = Field(default=None, description="Fecha de nacimiento en formato ISO YYYY-MM-DD.")
    portrait_bbox: Optional[List[int]] = Field(default=[0, 0, 0, 0], description="Coordenadas normalizadas [ymin, xmin, ymax, xmax] del rostro.")

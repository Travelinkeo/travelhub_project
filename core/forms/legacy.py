...
from core.models import BoletoImportado, FeeVenta
...
class PasajeroForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'numero_documento': forms.TextInput(attrs={'class': 'bg-gray-800/50 border border-gray-700 text-white rounded-xl px-4 py-2 w-full'}),
            ...
            'tipo_documento': forms.Select(attrs={'class': 'bg-gray-800/50 border border-gray-700 text-white rounded-xl px-4 py-2 w-full'}),

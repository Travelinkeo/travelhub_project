...
class AgencyBrandingForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ["logo", "color_primario", "eslogan", "pie_pagina"]
        widgets = {
            "eslogan": forms.TextInput(
                attrs={
                    "class": "bg-slate-800 border border-slate-700 text-white rounded-lg block w-full p-2.5"
                }
            ),
            "pie_pagina": forms.Textarea(
                attrs={
                    "rows": 3,
                    "class": "bg-slate-800 border border-slate-700 text-white rounded-lg block w-full p-2.5",
                }
            ...
            "color_primario": forms.TextInput(
                attrs={
                    "type": "color",
                    "class": "h-10 w-20 bg-transparent border-0 cursor-pointer rounded",
                }
            ),
...
class AgencyAutomationForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "email_monitor_password": forms.PasswordInput(
                render_value=True,
                attrs={
                    "class": "bg-slate-800 border border-slate-700 text-white rounded-lg block w-full p-2.5",

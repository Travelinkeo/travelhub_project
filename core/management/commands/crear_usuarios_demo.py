...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            self.stderr.write("  [ERROR] No se encontro la agencia 'Travelinkeo'. Agencias existentes:")
        ...
        for datos in USUARIOS:
            ...
            self.stdout.write(f"  [{estado}] {user.username} -> {agencia_travelinkeo.nombre} | rol: vendedor")
        ...
        self.stdout.write(f"  [{estado_demo}] {agencia_demo.nombre} | plan: {agencia_demo.plan} | demo: True")
        ...
        self.stdout.write(f"  Agencia de pruebas : {agencia_demo.nombre}  (plan={agencia_demo.plan}, demo=True)")
        self.stdout.write("")

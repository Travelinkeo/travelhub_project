...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("--expires", type=int, default=90, help="Dias hasta expiracion (default: 90)")
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(f"  Expira:   {key.expires_at.strftime('%Y-%m-%d') if key.expires_at else 'Nunca'}")

...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        tarifario, created = TarifarioProveedor.objects.get_or_create(
            ...
            defaults={
                "fecha_vigencia_inicio": datetime.strptime(
                    data["vigencia"]["inicio"], "%Y-%m-%d"
                ).date(),
        ...
        for hotel_data in data.get("hoteles", []):
            ...
            hotel, created = HotelTarifario.objects.get_or_create(
                ...
                defaults={
                    ...
                    "comision": Decimal(
                        hotel_data.get("comision", data.get("comision_estandar", "15.00"))
                    ),
                ...
                for tarifa_data in hab_data.get("tarifas", []):
                    TarifaHabitacion.objects.get_or_create(
                        ...
                        fecha_inicio=datetime.strptime(
                            tarifa_data["fecha_inicio"], "%Y-%m-%d"
                        ).date(),
                        ...
                        defaults={
                            ...
                            "tarifa_pax_adicional": self._parse_decimal(
                                tarifa_data.get("pax_adicional")
                            ),

...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--nombre", type=str, default="Tarifario Nacional", help="Nombre del tarifario"
        )
            ...
            try:
                with transaction.atomic():
                    ...
                    hotel = HotelTarifario.objects.create(
                        ...
                        minimo_noches_temporada_baja=hotel_data["politicas"].get(
                            "minimo_noches_baja", 1
                        ),
                        minimo_noches_temporada_alta=hotel_data["politicas"].get(

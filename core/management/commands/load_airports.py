...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        PRINCIPALES_IATA = {
            "CCS", "PMV", "MAR", "BLA", "STD", "LFR", "MIA", "JFK", "MAD", 
            "BOG", "PTY", "CDG", "LHR", "EZE", "GRU", "MEX", "CUN"
        }
        ...
        self.stdout.write(f"Guardando {len(aeropuertos_a_crear)} aeropuertos comerciales en la base de datos...")
        ...
        self.stdout.write(self.style.SUCCESS(f"¡Base de datos de aeropuertos cargada exitosamente! Se importaron {contador} registros."))

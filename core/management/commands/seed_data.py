...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        moneda_usd, _ = Moneda.objects.get_or_create(
            codigo_iso="USD",
            defaults={"nombre": "Dólar Americano", "simbolo": "$", "es_moneda_local": False},
        )
        moneda_ves, _ = Moneda.objects.get_or_create(
            codigo_iso="VES",
            defaults={"nombre": "Bolívar Soberano", "simbolo": "Bs.", "es_moneda_local": True},
        )
        moneda_eur, _ = Moneda.objects.get_or_create(
            codigo_iso="EUR", defaults={"nombre": "Euro", "simbolo": "€", "es_moneda_local": False}
        )
        ...
        with system_context():
            ProductoServicio.objects.get_or_create(
                ...
                defaults={
                    "nombre": "Boleto Aéreo",
                    "tipo_producto": "AIR",
                    "descripcion": "Emisión de boleto aéreo",
                },
            )
            ProductoServicio.objects.get_or_create(
                codigo_interno="FEE-SERV",
                defaults={
                    "nombre": "Fee de Servicio",
                    "tipo_producto": "FEE",
                    "descripcion": "Honorarios por gestión",
                },
            )

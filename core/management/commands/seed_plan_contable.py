...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        cuentas = [
            ...
            {
                "codigo": "1.1.03",
                "nombre": "Banco Internacional / Zelle",
                "tipo": "AC",
                "nivel": 3,
                "padre": "1.1",
                "movimiento": True,
            ...
            {
                "codigo": "5.2.03",
                "nombre": "Licencias de Software (GDS, TravelHub)",
                "tipo": "GA",
                "nivel": 3,
                "padre": "5.2",
                "movimiento": True,
        ...
        with transaction.atomic():
            ...
            self.stdout.write(
                self.style.SUCCESS(f"Finalizado: {creados} cuentas creadas, {omitidos} existentes.")
            )

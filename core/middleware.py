            ...
            if is_debug or is_admin_path:
                ...
                csp = "; ".join(
                    [
                        ...
                        f"script-src 'self' 'unsafe-eval' 'nonce-{nonce}' 'strict-dynamic' {static_origin} https://static.cloudflareinsights.com https://cdn.jsdelivr.net https://cdn.tailwindcss.com https://unpkg.com https://code.jquery.com",

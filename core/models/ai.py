...
class AIUsageLog(models.Model):
    ...
    agencia = models.ForeignKey(Agencia, on_delete=models.CASCADE, null=True, blank=True, related_name='ai_logs')
    model_name = models.CharField(max_length=50, choices=MODELS)
    feature = models.CharField(max_length=100)  # 'ticket_parsing', 'reconciliation', 'marketing_copy', etc.

...
class TramoVueloSchema(BaseModel):
    ...
    origen: str = Field(description="Ciudad de origen. Usa SIEMPRE el nombre completo de la ciudad (ej. BOGOTA, PANAMA, CARACAS). PROHIBIDO usar códigos IATA de 3 letras.")
    ...
    destino: str = Field(description="Ciudad de destino. Usa SIEMPRE el nombre completo de la ciudad (ej. BOGOTA, PANAMA, CARACAS). PROHIBIDO usar códigos IATA de 3 letras.")
    hora_llegada: str = Field(description="Hora de llegada en formato 24h HH:MM (ej: 15:10). NUNCA usar AM/PM.")
    fecha_llegada: str = Field(description="Fecha de llegada en formato GDS DDMMMAA en mayúsculas (ej: 29MAR26). Puede ser diferente a la fecha de salida en vuelos nocturnos.")

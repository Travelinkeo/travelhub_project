...
class TipoCambio(models.Model):
    ...
    moneda_origen = models.ForeignKey(Moneda, related_name='tipos_cambio_origen', on_delete=models.PROTECT, verbose_name=_("Moneda Origen"), null=True, blank=True)
    moneda_destino = models.ForeignKey(Moneda, related_name='tipos_cambio_destino', on_delete=models.PROTECT, verbose_name=_("Moneda Destino"), null=True, blank=True)
...
class ComisionProveedorServicio(models.Model):
    ...
    proveedor = models.ForeignKey(Proveedor, on_delete=models.CASCADE, related_name='comisiones', verbose_name=_("Proveedor"), null=True, blank=True)
...
class TasaCambio(models.Model):
    ...
    Almacena la tasa diaria del BCV. Si la página gubernamental se cae, 
    el sistema busca el registro más reciente aquí para no detener las ventas.
    """
    fecha = models.DateField(db_index=True)
    moneda = models.CharField(max_length=3, default='USD', choices=[('USD', 'Dólar'), ('EUR', 'Euro')])

...
class FlashMarketingService:
    ...
    def generate_flyer(self, destination: str, price: str, airline: str = None, agency_logo_path: str = None) -> BytesIO:
        ...
        try:
            ...
            # Footer (Subido un poco)
            # Antes estaba en height - 200. Lo subimos a height - 350
            footer_y_text = self.height - 350
            draw.text((self.width//2, footer_y_text), "Reserva con", font=font_small, fill="white", anchor="mm")

            # 5. Agregar Logo Agencia
            # Prioridad: Logo Agencia > Logo Blanco Default > Logo Alternativo
            logo_to_use = None
            ...
            if logo_to_use:
                try:
                    ...
                    # Redimensionar logo a max 300px ancho o 150px alto
                    max_w = 300
                    max_h = 150
                    ...
                    # Pegar debajo del texto "Reserva con"
                    # El texto está en footer_y_text. El logo irá ~80px más abajo
                    logo_x = (self.width - new_w) // 2
                    logo_y = footer_y_text + 60 

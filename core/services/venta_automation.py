...
from apps.bookings.models import (
    Venta, BoletoImportado, ItemVenta, ProductoServicio, Proveedor
)
...
from core.services.itinerary_service import ItineraryService
...
class VentaAutomationService:
    ...
    def crear_venta_desde_parser(cls, parsed_data, agencia, usuario=None, forced_cliente_id=None, proveedor_id=None, boleto_obj=None):
        ...
        with transaction.atomic():
            ...
            # H. Sales Intelligence (Audit Point 7)
            try:

...
# from core.models import BoletoImportado, Venta, ItemVenta, PagoVenta
...
def crear_o_actualizar_venta_desde_boleto(sender, instance, created, **kwargs):
    from core.models import BoletoImportado, Venta, ItemVenta
    from core.models_catalogos import Moneda, ProductoServicio
    ...
    if instance.archivo_boleto and not instance.datos_parseados:
        try:
            ...
            if updated_count > 0:
                from core.tasks import procesar_boleto_task
                ...
                # Direct delay call
                procesar_boleto_task.delay(instance.pk)
                return 
            else:
...
def enviar_confirmacion_pago_recibido(sender, instance, created, **kwargs):
    from core.models import PagoVenta

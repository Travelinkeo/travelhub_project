...
urlpatterns = [
    ...
    # Configuración Agencia
    path('agencia/configuracion/', agencia_views.AgenciaSettingsView.as_view(), name='agencia_settings'), # Antes perfil
    path('agencia/usuarios/', agencia_views.AgenciaUsersListView.as_view(), name='agencia_usuarios'), # Antes usuarios_list
    ...
    path(r'api/boletos/<int:pk>/retry/', BoletoRetryParseAPIView.as_view(), name='api_boleto_retry'),

...
def test_assistant():
    ...
    response = assistant.ask(
        "Explicame por que el boleto 1230000000002 tiene una diferencia financiera."
    )
    ...
    response = assistant.ask(
        "Dime que asiento contable (Debe/Haber) me sugieres para arreglar la diferencia de 5.5 del boleto 1230000000002."
    )
    print(f"ASSISTANT: {response}")

...
with open(
    r"C:\Users\ARMANDO\Downloads\Itinerary for Record Locator DYEXFG.eml",
    encoding="utf-8",
    errors="ignore",
) as f:
    content = f.read()
...
print(
    f"   - 'RECIBO DE PASAJE ELECTRÓNICO' in text: {'RECIBO DE PASAJE ELECTRÓNICO' in content.upper()}"
)

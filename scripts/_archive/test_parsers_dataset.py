        ...
        try:
            ...
            result = {
                ...
                "extracted_fields": {
                    ...
                    or parsed_data.get("NUMERO_DE_BOLETO")
                    or parsed_data.get("numero_boleto"),
                    "pnr": parsed_data.get("pnr")
                    or parsed_data.get("CODIGO_RESERVA")
                    or parsed_data.get("SOLO_CODIGO_RESERVA"),
                    "passenger": parsed_data.get("passenger_name")
                    or parsed_data.get("NOMBRE_DEL_PASAJERO"),
                    "airline": parsed_data.get("airline_name")
                    or parsed_data.get("NOMBRE_AEROLINEA"),
            ...
            print(f"    ❌ Error: {e}")
            results.append({"file": file_path.name, "gds_folder": gds_folder, "error": str(e)})

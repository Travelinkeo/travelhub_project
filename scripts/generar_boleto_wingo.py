    ...
    try:
        with transaction.atomic():
            ...
            pasajero, _ = Pasajero.objects.get_or_create(
                ...
                defaults={'nombres': nombre_completo[0], 'apellidos': " ".join(nombre_completo[1:]), 'email': datos_boleto['contact_email']}
            )
            ...
            for i, flight_data in enumerate(datos_boleto['flights']):
                ...
                SegmentoVuelo.objects.get_or_create(
                    ...
                    defaults={
                        ...
                        'aerolinea': flight_data['operated_by'], # Usar el valor de 'operado por' aquí
                    }
                )

    ...
    with transaction.atomic():
        for data in VENTAS_A_CONECTAR:
            ...
            try:
                ...
                if created:
                    print(
                        f"- Creado nuevo registro BoletoImportado (ID: {boleto_importado.id_boleto_importado})."
                    )
                else:
                    print(
                        f"- Encontrado registro BoletoImportado existente (ID: {boleto_importado.id_boleto_importado})."
                    )

...
uploaded_file = SimpleUploadedFile(
    name=Path(test_file).name, content=file_content, content_type="application/pdf"
)
...
if datos:
    ...
    print(
        f"   Passenger: {datos.get('passenger_name') or datos.get('pasajero', {}).get('nombre_completo')}"
    )

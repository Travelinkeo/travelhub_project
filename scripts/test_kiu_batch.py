...
def run_kiu_test():
    ...
    files = [
        f for f in os.listdir(INPUT_DIR) if f.lower().endswith((".pdf", ".eml", ".txt", ".html"))
    ]
    ...
    for idx, filename in enumerate(files):
        ...
        try:
            ...
            try:
                ...
                if not data.fares.get("total_amount"):
                ...
                if missing:
                    ...
                    print(
                        f"      Total: {data.fares.get('total_amount')} {data.fares.get('currency')}"
                    )
                    stats["success"] += 1
                ...
                if True:  # Intentar generar PDF siempre para ver resultado visual
                    ...
                    try:
                        ...
                        if pdf_bytes:
                            ...
                            print("      ⚠️ generate_ticket retornó bytes vacíos.")

...
if data.get("SOURCE_SYSTEM") == "SABRE":
    ...
    cond1 = (
        "ETICKET RECEIPT" in plain_text_upper
        or "RECIBO DE PASAJE" in plain_text_upper
        or "RECIBO DE BOLETO" in plain_text_upper
    )
    cond2 = (
        "RESERVATION CODE" in plain_text_upper
        or "CODIGO DE RESERVA" in plain_text_upper
        or "CODIGO DE RESERVACION" in plain_text_upper
        or "CÓDIGO DE RESERVA" in plain_text_upper
        or "CÓDIGO DE RESERVACIÓN" in plain_text_upper
    )

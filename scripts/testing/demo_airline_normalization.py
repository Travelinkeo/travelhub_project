...
def demo_parser_integration():
    ...
    normalized_airline = normalize_airline_name(
        mock_ticket_data["raw_airline_name"], mock_ticket_data["flight_number"]
    )
    ...
    print("\nBeneficios:")
    print("  - Consistencia en la base de datos")
    print("  - Mejor experiencia de usuario")
    print("  - Facilita reportes y análisis")
    print("  - Reduce duplicados por variaciones de nombre")

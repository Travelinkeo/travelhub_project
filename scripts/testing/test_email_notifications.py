...
def test_notifications():
    ...
    if not created and not cliente.telefono_principal:
        ...
        cliente.save()
    print(
        f"{'✓ Cliente creado' if created else '✓ Cliente existente'}: {cliente.get_nombre_completo()}"
    )
    ...
    print("   → Email de cambio de estado enviado")
    ...
    print("   → Email de confirmación de pago enviado")

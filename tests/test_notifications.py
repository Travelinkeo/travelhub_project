...
class TestPaymentNotifications:
    ...
    def test_notificar_confirmacion_pago(self, mock_wa, mock_email):
        ...
        from apps.communications.services.notification_dispatcher import notificar_confirmacion_pago as notif
        pago_venta = Mock()
        notif(pago_venta)
    ...
    def test_notificar_recordatorio_pago(self, mock_wa, mock_email):
        ...
        from apps.communications.services.notification_dispatcher import notificar_recordatorio_pago as notif
        venta = Mock()
        result = notif(venta)
...
class TestTicketNotifications:
    ...
    def test_notificar_boleto_procesado_admin_only(self, mock_email, mock_whatsapp, settings):
        ...
        boleto.datos_parseados = {'normalized': {'reservation_code': 'ABC123', 'passenger_name': 'John Doe'}}
    ...
    def test_enviar_recordatorio_vuelo(self, mock_whatsapp):
        ...
        boleto.datos_parseados = {
            'normalized': {
                ...
                'flights': [{'origin': 'CCS', 'destination': 'MIA', 'date': '2024-01-01', 'time': '10:00'}]
            }
        }
        boleto.localizador_pnr = 'ABC123'
        boleto.nombre_pasajero_procesado = 'John Doe'
    ...
    def test_enviar_recordatorio_vuelo_no_flights(self):
        ...
        boleto = Mock()
        boleto.venta_asociada = venta
        boleto.datos_parseados = {'normalized': {'reservation_code': 'ABC123', 'passenger_name': 'John', 'flights': []}}
        boleto.localizador_pnr = 'ABC123'

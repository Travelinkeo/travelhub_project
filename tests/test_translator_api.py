...
class TranslatorAPITestCase(TestCase):
    def setUp(self):
        ...
        self.pais = Pais.objects.create(nombre='Estados Unidos', codigo_iso_2='US', codigo_iso_3='USA')
        self.aerolinea = Aerolinea.objects.create(codigo_iata='AA', nombre='American Airlines', pais_origen='Estados Unidos', activa=True)

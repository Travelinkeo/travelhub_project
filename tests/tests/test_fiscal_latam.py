...
class TestFiscalLatam:
    ...
    def test_libro_compras_generation_json_and_csv(self):
        ...
        # Test JSON
        response = self.client.get(url, {"fecha_inicio": "2026-07-01", "fecha_fin": "2026-07-31", "formato": "json"})
        ...
        # Test CSV
        response_csv = self.client.get(url, {"fecha_inicio": "2026-07-01", "fecha_fin": "2026-07-31", "formato": "csv"})
        ...
        assert b"100.00;16.00" in response_csv.content or b"100.00;0.00;16.00" in response_csv.content
    ...
    def test_retenciones_islr_xml_generation(self):
        ...
        assert "<RifRetenido>J888888888</RifRetenido>" in xml_content  # RIF sanitizado (sin guiones)
